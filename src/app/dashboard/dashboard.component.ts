...
export class DashboardComponent implements OnInit {
  ...
  allcallcount(lastFourDid: any) {
    this.userService.getallcallcount(lastFourDid).subscribe(
      (response: any) => {
        console.log(response)
  ...
  alloutgoingcount(lastFourDid: any) {
    this.userService.getoutgoingcallcount(lastFourDid).subscribe(
      (response: any) => {
        // console.log(response)
  ...
  allincomingcount(lastFourDid: any) {
    this.userService.getincomingcallcount(lastFourDid).subscribe(
      (response: any) => {
        //  console.log(response)
  ...
  allmissedcount(lastFourDid: any) {
    this.userService.getmissedcallcount(lastFourDid).subscribe(
      (response: any) => {
        //  console.log(response)
